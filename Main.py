...
try:
	...
	bot = commands.AutoShardedBot(command_prefix=get_prefix, pm_help=None, description='A Typical Miku', shard_count=4, intents=intents, allowed_mentions=allowed_mentions)
except:
	# Possibly using the old gateway?
	print("Using the old gateway - this may not be around forever...\n")
	bot = commands.AutoShardedBot(command_prefix=get_prefix, pm_help=None, description='A Typical Miku ', shard_count=4, allowed_mentions=allowed_mentions)
